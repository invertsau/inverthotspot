...
fields_we_want <- c("phylum", "class",  "order", "family",  "genus", "species", "taxonRank", "taxonID",
...
```{r}
write_parquet(joined_data, paste0("data/galah/Mygalomorphae_withassertions", Sys.Date(), "_ALA.parquet"))
```
