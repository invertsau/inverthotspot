...
# Run the MC simulation
R_MI_point_ex  <-  moran.mc(m1.point_ex$richness, lw, nsim=9999,zero.policy=T)
WE_MI_point_ex  <-  moran.mc(m1.point_ex$WE, lw, nsim=9999,zero.policy=T)
CWE_MI_point_ex <-  moran.mc(m1.point_ex$corrected_endemism, lw, nsim=9999,zero.policy=T)
