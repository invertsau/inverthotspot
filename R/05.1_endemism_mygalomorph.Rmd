...
pacman::p_load(arrow, here, phyloregion, terra, sf, sp, tidyverse, ggplot2, ozmaps, tmap, viridis, spdep, purrr, gstat)
...
# resampling sampling rate raster to get it to match the extent of the biodiversity raster
...
WE_samp_bias <- terra::app(x = c(m1.poly_raster$WE, sampling_rate_raster_ea_resample), 
                           fun = function(x){return(x[1]/x[2])})
CWE_samp_bias <- terra::app(x = c(m1.poly_raster$corrected_endemism, sampling_rate_raster_ea_resample), 
                                 fun = function(x){return(x[1]/x[2])})
richness_samp_bias <- terra::app(x = c(m1.poly_raster$richness, sampling_rate_raster_ea_resample), 
                                 fun = function(x){return(x[1]/x[2])})
...
# correcting biodiversity metrics based on (log+1) estimated sampling rate (dividing by sampling rate)
WE_sr_samp_bias <- terra::app(x = c(m1.poly_sr_raster$WE, sampling_rate_raster_ea_resample), 
                           fun = function(x){return(x[1]/x[2])})
CWE_sr_samp_bias <- terra::app(x = c(m1.poly_sr_raster$corrected_endemism, sampling_rate_raster_ea_resample), 
                                 fun = function(x){return(x[1]/x[2])})
richness_sr_samp_bias <- terra::app(x = c(m1.poly_sr_raster$richness, sampling_rate_raster_ea_resample), 
                                 fun = function(x){return(x[1]/x[2])})
...
# correcting biodiversity metrics based on (log+1) estimated sampling rate (dividing by sampling rate)
WE_ex_samp_bias <- terra::app(x = c(m1.poly_ex_raster$WE, sampling_rate_raster_ea_resample), 
                           fun = function(x){return(x[1]/x[2])})
CWE_ex_samp_bias <- terra::app(x = c(m1.poly_ex_raster$corrected_endemism, sampling_rate_raster_ea_resample), 
                                 fun = function(x){return(x[1]/x[2])})
richness_ex_samp_bias <- terra::app(x = c(m1.poly_ex_raster$richness, sampling_rate_raster_ea_resample), 
                                 fun = function(x){return(x[1]/x[2])})
...
# resampling sampling rate raster to get it to match the extent of the biodiversity raster
sampling_rate_raster_ea_resample <- resample(sampling_rate_raster_ea, m1.poly_sr_ex_raster, method = "bilinear")

# correcting biodiversity metrics based on (log+1) estimated sampling rate (dividing by sampling rate)
WE_sr_ex_samp_bias <- terra::app(x = c(m1.poly_sr_ex_raster$WE, sampling_rate_raster_ea_resample), 
                           fun = function(x){return(x[1]/x[2])})
CWE_sr_ex_samp_bias <- terra::app(x = c(m1.poly_sr_ex_raster$corrected_endemism, sampling_rate_raster_ea_resample), 
                                 fun = function(x){return(x[1]/x[2])})
richness_sr_ex_samp_bias <- terra::app(x = c(m1.poly_sr_ex_raster$richness, sampling_rate_raster_ea_resample), 
                                 fun = function(x){return(x[1]/x[2])})
