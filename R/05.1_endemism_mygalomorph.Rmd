...
# saveRDS(merged_geo, here("data/protected_areas/bias_corrected_hotspots_spatraster.rds"))
...
# Assigning hotspots based on percentile
merged_geo$WE_perc <- merged_geo_df$WE_sampbias_corrected > quantile(merged_geo_df$WE_sampbias_corrected, probs = 0.95)
merged_geo$CWE_perc <- merged_geo_df$CWE_sampbias_corrected > quantile(merged_geo_df$CWE_sampbias_corrected, probs = 0.95)
merged_geo$rich_perc <- merged_geo_df$richness_sampbias_corrected > quantile(merged_geo_df$richness_sampbias_corrected, probs = 0.95)
```
