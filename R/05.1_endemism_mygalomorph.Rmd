...
```{r}
m1.poly$rich_perc <- m1.poly$richness > quantile(m1.poly$richness, probs = 0.975)
m1.poly$WE_perc <- m1.poly$WE > quantile(m1.poly$WE, probs = 0.975)
m1.poly$CWE_perc <- m1.poly$corrected_endemism > quantile(m1.poly$corrected_endemism, probs = 0.975)
```
