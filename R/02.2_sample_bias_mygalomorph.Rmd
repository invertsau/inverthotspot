...
pacman::p_load(galah, arrow, here, tidyverse, janitor, ozmaps, sf, ggplot2, wesanderson, dplyr, DT, sampbias, viridis, rnaturalearthdata, remotes, terra, occAssess)
...
## Population density
data downloaded from earthdata.nasa.gov (gridded population fo the world, v4)

```{r}
pop_density <- rast("data/sampling_bias/pop_density/gpw_v4_population_density_adjusted_to_2015_unwpp_country_totals_rev11_2020_2pt5_min.tif")
