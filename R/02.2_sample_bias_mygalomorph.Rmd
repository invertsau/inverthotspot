...
aus <- st_transform(ozmaps::ozmap_states, "EPSG:9473")
...
job::job(
  ...
  res = 5000,   # scale of spatial resolution
  buffer = 50000, # account for neighbouring features
...
# Map
bias_map <- sampbias::map_bias(model_bias_myg_proj, type="log_sampling_rate")
  
  saveRDS(model_bias_myg, "output/sampbias_mygals.rds")
  saveRDS(bias_map, "output/samp_bias_map.rds")
  }
)
```

```{r}
model_bias_myg <- readRDS("output/sampbias_mygals.rds")
