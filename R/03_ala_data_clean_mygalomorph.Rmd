...
#number of total, clean, and flagged
nrow(flagged)
nrow(subset(flagged, .summary==TRUE))
nrow(subset(flagged, .summary==FALSE))
...
```{r, echo=F}
myg_species_clean <- flagged[flagged$.summary,]
nrow(myg_species_clean)
```
