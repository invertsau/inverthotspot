...
## Read in parquet
myg_spiders_all <- open_dataset(get_latest_download())
...
taxonRank = unranked for _Selenocosmia crassipes_ as this taxon represents a cryptic species complex with unresolved phylogeny.
...
`r total_myg - nrow(myg_spp)` species (`r ((total_myg - nrow(myg_spp))/total_myg)*100`%) do not have 3 or more records. There are `r single_record_spp` species (`r (single_record_spp/total_myg)*100`%) with a single record.
