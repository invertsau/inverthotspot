...
Moran's I statistic was used to identify spatial clustering in biodiversity metrics and test whether spatial patterns were statistically significant.
...
- Both datasets showed a hotspot of CWE in south-west Western Australia. The full dataset also showed a small hotspot in far north Queensland at the tip of Cape York, while the preserved specimen only dataset showed a small cluster located between Canberra and Sydney in New South Wales.
