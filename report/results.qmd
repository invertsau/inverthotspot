...
Both datasets showed a large hotspot in south-west Western Australia. The full dataset showed a small hotspot in far north Queensland at the tip of Cape York, while the preserved specimen only dataset also showed a small cluster located between Canberra and Sydney in New South Wales (Figure 9).
