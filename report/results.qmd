...
::: {.callout-note}
Hotspots of **species richness** were identified in both the combined dataset and the preserved specimen only dataset: a large cluster centred around Brisbane, spanning south-east Queensland and north-east New South Wales, and another centred around Cairns in the Wet Tropics of Queensland (Figure 5).
:::
