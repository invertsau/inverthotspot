...
After testing for spatial autocorrelation across the whole study region (Australia), Local Moran's I was used to assess the significance of clustering of similar values around each spatial unit, thereby allowing specific hotspots to be identified. 
