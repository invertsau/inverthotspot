...
::: {.callout-important}
We identified `r length(less_than_3_obs)` species with three or fewer observations. This resulted in an exclusion of `r deduplicated_myg_spiders |> filter(scientificName %in% less_than_3_obs) |> nrow()` observations ().  
:::
