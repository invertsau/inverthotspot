...
We then use the World Spider Catalogue to exclude introduced spiders from the dataset.
...
We also used the Global Register of Invasive and Introduced Species (GRIIS) to check for and remove introduced species.
