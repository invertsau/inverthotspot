...
::: {.callout-important}
There were  `r nrow(citsci)` records that were flagged with basis of record = `"HUMAN_OBSERVATION"`. This resulted in an exclusion of `r (( nrow(citsci) / nrow(myg_spiders) )*100) |> round(2)`% of the original data).  
:::
